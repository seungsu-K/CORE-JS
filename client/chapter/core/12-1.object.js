...
authUser.permission = 'free'; // setter
...
// 프로퍼티 포함 여부 확인 => 객체 안에 키가 있는지 확인하는 방법
// in 문

console.log('uid' in authUser); // true

Object.prototype.nickName = '호랑이'; // 닉테임은 상위 요소인 Object의 프로퍼티라 안나옴
...
// 객체의 key만 모아서 배열을 반환하는 메서드 Object.keys()
const keyList = Object.keys(authUser);

// 객체의 value만 모아서 배열을 반환하는 메서드 Object.values()
const valueList = Object.values(authUser);

// 객체의 [key,value]를 모아서 배열을 반환하는 매서드 Object.entries()
const entryList = Object.entries(authUser);
...
const [a0, , a2, a3, a4 = 999] = arr;

for (let [key, value] of Object.entries(authUser)) {
  console.log(key, value);
}

const a = Object.entries(authUser).filter(([key, value]) => {
  return value;
});
...
// 함수 안에 있는 변수이기 때문에 함수 안에서 j 사용 가능
