...
// 내림
let floor = Math.floor(number); // 90127

// 반올림
let round = Math.round(number); // 90128

// 올림
let ceil = Math.ceil(number); // 90128

// 절삭(소수점 이하)
let truncate = Math.trunc(number); // 90127
